...
export function proxy(request: NextRequest) {
  ...
  if (isDev) {
    ...
    cspDirectives.push(
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co ws://localhost:* http://localhost:* https://va.vercel-scripts.com https://vitals.vercel-insights.com https://formsubmit.co",
    ...
    cspDirectives.push(
      ...
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: blob: https://*.supabase.co",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://va.vercel-scripts.com https://vitals.vercel-insights.com https://formsubmit.co",
      "frame-ancestors 'none'",
      "form-action 'self'",
      "object-src 'none'",
      "base-uri 'self'",
